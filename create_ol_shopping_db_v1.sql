...
CREATE TABLE IF NOT EXISTS `ol_shopping`.`vendor` (
  `vendor_no` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ol_shopping`.`product` (
  ...
  PRIMARY KEY (`product_no`, `vendor_no`),
...
CREATE TABLE IF NOT EXISTS `ol_shopping`.`order_header` (
  ...
  PRIMARY KEY (`order_no`, `transporter_no`, `customer_no`),
...
CREATE TABLE IF NOT EXISTS `ol_shopping`.`order_detail` (
  `orderdetail_no` INT NOT NULL AUTO_INCREMENT,
  `order_no` INT NOT NULL,
  `product_no` INT NOT NULL,
  `quantity` INT NOT NULL,
  PRIMARY KEY (`orderdetail_no`, `product_no`, `order_no`),
